...
By leveraging united or unused snippets of information retrieved during the discussion, the Moderator ensures the conversation remains dynamic and avoids repetitive or overly niche topics.
...
class KnowledgeBaseSummmary(dspy.Signature):
    """Your job is to give brief summary of what's been discussed in a roundtable conversation. Contents are thematically organized into hierarchical sections.
...
class ConvertUtteranceStyle(dspy.Signature):
    ...
    expert = dspy.InputField(prefix="You are invited as: ", format=str)
