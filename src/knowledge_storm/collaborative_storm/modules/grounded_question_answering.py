...
class AnswerQuestion(dspy.Signature):
    ...
    If [Gathered information] is not directly related to the [Topic] and [Question], provide the most relevant answer you can be based on the available information, and explain any limitations or gaps.
